...
Если активность предназначена для выполняется в режиме исследования, то у нее есть признак :t_exploration:`исследование`.
...
Правила так же часто имеют признаки связанные с ним (признаки перечислены в :ref:`Appendix--Traits`).
