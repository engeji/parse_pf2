...
Вы получаете заклинание ордена *goodberry* и увеличиваете запас очков фокусировки на 1.
...
Вы так же получаете способность друида "Бурерожденный"
...
Вы получаете способность друида "Дикая форма".
Вы получаете заклинание ордена *wild morph*.
...
Вы добавляете обличая, перечисленные в *гуманоидных обличиях* в списке *дикой формы*.
