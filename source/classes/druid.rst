...
Вы получаете общую способность :ref:`feat--Shield-Block` - реакцию, которая позволяет снижать повреждения с помощью щита.
...
Дикая форма (`Wild Shape <https://2e.aonprd.com/Feats.aspx?ID=316>`_) / 1 ур.
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
Вы получаете заклинание ордена :ref:`spell--focus--Wild-Shape`, что позволяет вам перевоплощаться в различные формы, которые вы можете получать с помощью способностей друида.
...
Вы добавляете формы, перечисленные в заклинании :ref:`spell--h--Humanoid-Form`, в список доступных для :ref:`spell--focus--Wild-Shape`.
