...
Всякий раз, когда вы успешно проходите спасбросок против эффекта с признаком :t_divination:`прорицание` или :t_mental:`ментальный`, то в качестве свободного действия (|д-св|) с триггером успешного прохождения спасброска, можете сделать :ref:`expl-activity--Identify-Magic`, чтобы идентифицировать заклинание, даже если не заметили, что это заклинание было сотворено.
...
Как обычно, для состояния :c_concealed:`скрыт` связанного с очевидным визуальным проявлением, вы не можете использовать его, чтобы :ref:`skill--Stealth--Hide`.
