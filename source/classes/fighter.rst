...
В дополнение, вы получаете бонус обстоятельства +2 к проверкам Восприятия для инициативы, позволяя вам быстрее реагировать в бою.
...
Когда используете дистанционное оружие, которое не имеет признака "залповое", вы получаете бонус обстоятельства +2 к повреждениям, против целей целей в первом шаге дистанции оружия.
...
.. _class-feature--fighter--Agile-Grace:
...
.. _class-feature--fighter--Certain-Strike:
...
Даже когда вы не попали точно, вы можете провести скользящим ударом.
Сделайте :ref:`action--Strike` в ближнем бою.
Он получает следующий эффект эффект неудачи.

**Неудача**: Ваша атака наносит такое же количество повреждений, какое бы она сделала при попадании, за исключением всех костей повреждений.
(Это убирает кости повреждений от рун оружия, заклинаний и специальных способностей, в дополнение к костям повреждения оружия).


.. _class-feature--fighter--Combat-Reflexes:
...
.. _class-feature--fighter--Debilitating-Shot:
...
Целясь в слабое место, точным выстрелом, вы мешаете противнику.
Сделайте :ref:`action--Strike` с дистанционным оружием.
Если он попадает и наносит повреждения, цель получает состояние "замедлен 1" до конца своего следующего хода.


.. _class-feature--fighter--Disarming-Twist:
...
**Требования**: Вы используете только одно одноручное оружие ближнего боя и другая рука(и) свободна.
...
Так же, этот удар имеет следующий эффект неудачи.

**Неудача**: Цель застигнута врасплох до конца вашего текущего хода.


.. _class-feature--fighter--Disruptive-Stance:
...
Пока вы находитесь в этой стойке, вы можете использовать :ref:`class-feature--fighter--Attack-Of-Opportunity` когда существо в вашей досягаемости использует действие с признаком "концентрация", в дополнение к обычным признакам "движение" и "воздействие".
...
.. _class-feature--fighter--Fearsome-Brute:
...
Вы получаете бонус обстоятельства к броскам на повреждениям по напуганным существам.
Бонус равен удвоенному значению состояния испуга существа.

Если вы мастер Запугивания, то увеличиваете бонус до утроенного значения состояния испуга существа.


.. _class-feature--fighter--Improved-Knockdown:
...
**Предварительные условия**: :ref:`class-feature--fighter--Knockdown`

----------

Вы можете сбить противника на землю одним ударом.
Когда используете :ref:`class-feature--fighter--Knockdown`, вы можете одним ударом сделать :ref:`action--Strike` а потом :ref:`skill--Athletics--Trip`.
Если вы так делаете и :ref:`action--Strike` попадает, вы так же применяете крит.успешный эффект от :ref:`skill--Athletics--Trip`.
Если при ударе вы использовали двуручное оружие ближнего боя, то можете использовать размер кости повреждения оружия, вместо обычного размера кости повреждений от критического :ref:`skill--Athletics--Trip`.


.. _class-feature--fighter--Mirror-Shield:
...
Сделайте дистанционную атаку против спровоцировавшего существа, используя ваш наилучший уровень мастерства с дистанционным оружием.
Если вы можете колдовать заклинания, то вместо этого можете сделать атаку заклинанием.
Если вы преуспели, противник получает эффекты успешной атаки своего заклинания (или эффекты крит.успеха если ваша атака была крит.успехом).


.. _class-feature--fighter--Twin-Riposte:
