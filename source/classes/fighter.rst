...
Когда вы делаете ежедневные приготовления, вы получаете одну способность воина 8-го уровня или ниже, которой у вас нет.
...
Сделайте :ref:`action--Strike` два раза, по одному удару каждым из требуемых оружий, и каждый удар использует ваш текущий штраф множественной атаки.
Оба Удара должны быть по одной цели.
Если второй Удар сделан оружием, без признака "быстрое", то он получает штраф -2.

Если обе атаки попадают, объедините их урон и потом добавляйте любые применимые эффекты от обоих оружий.
Вы добавляете любой точный урон только один раз, к атаке на ваш выбор.
Объедините урон от обоих Ударов и примените сопротивления и слабости только один раз.
Это считается как две атаки при расчете штрафа множественной атаки.
...
Если выстрел попадает, то следующее существо, кроме вас, которое атакует ту же цель до начала вашего следующего хода получает к своему броску бонус обстоятельства +1, или бонус обстоятельства +2 если ваш Выстрел был критическим попаданием.
...
Вы нацеливаете свое оружие, чтобы зацепить доспех, одежду или плоть противника, для того, чтобы подтянуть его ближе.
Сделайте :ref:`action--Strike` ближнего боя.
...
Когда вы двигаете существо, вы можете передвинуться на ту же дистанцию и в том же направлении, что и оно, даже если вы рядом с целью.
...
**Требования**: Вы владеете заряженным дистанционным оружием или дистанционным оружием с "перезарядка 0"
...
Вы делаете :ref:`action--Step` и потом делаете дистанционный :ref:`Выстрел (Strike) <action--Strike>` с требуемым оружием.
...
Поколебать защиту (`Shatter Defenses <https://2e.aonprd.com/Feats.aspx?ID=385>`_) |д-2| / 6
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
Вы бьете удерживаемого врага, в надеясь ошеломить его.
Сделайте :ref:`action--Strike` ближнего боя по существу, которое схвачено вами.
Урон оружием от этого Удара - дробящий.
...
Когда вы крит.успешно проходите спасбросок Воли против способности противника, вы на 1 минуту получаете бонус состояния +1 к спасброскам и количество временных ОЗ, равных половине вашего уровня.
...
Вы можете отбить в сторону дистанционную атаку.
...
Вы можете использовать "Атаку с отскока" когда Роете, Карабкаетесь, Летите или Плывете, вместо :ref:`action--Stride`, если у вас есть соответствующий вид перемещения.
...
Если вы выбираете заклинание, сделайте проверку противодействия заклинанию (ваш уровень противодействия равен половине вашего уровня, округленного до большего целого, и вы пытаетесь сделать спасбросок Воли, в качестве проверки противодействия).
...
Если при броске вы получили крит.попадание, то ваша атака так же получает признак "смертельная d12".
...
В то время как 1-я способность все еще должна быть 8-го уровня или ниже, 2-я способность может быть вплоть до 14-го уровня, и 3-я может быть вплоть до 18-го уровня.
...
Вы должны соответствовать всем предварительным условиям способностей.
В дополнение, вы можете вы можете адаптироваться к вызовам на поле боя потратя 1 час на тренировку.
Если вы так делаете, то можете перевыбрать способности, выбранные с :ref:`class-feature--Fighter--Combat-Flexibility` во время ежедневных приготовлений.
