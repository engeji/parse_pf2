...
В зависимости от ситуации, Мастер может добавить этой реакции любые подходящие признаки, как например "слуховой" и "языковой", если вы словесно передаете информацию.
...
Даже если вы перестали расследовать надежную зацепку, то все равно можете вернуться к ней сколько угодно раз, используя одиночное действие (|д-1|), которое получает признак "концентрация".
