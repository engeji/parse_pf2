...
Если у вас есть любые специальные умения или свободные действия, которые обычно были бы спровоцированы вашим использованием "Вспомнить изученное", вы не можете использовать их с этими действиями.
...
Когда вы используете "Вспомнить изученное", то получаете результат на одну степень успешнее и если эффект (такой как :ref:`feat--Dubious-Knowledge`) дал бы вам неточную информацию при проверке "Вспомнить изученное", то узнаете какая информация неверна.
Когда один из ваших союзников "Вспоминает изученное" и получает ложную информацию, то вы также знаете, что эта информация неверная, если они с вами ею поделятся.
