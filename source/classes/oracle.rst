...
.. table:: Таблица: Заклинания оракула в день
...
**Пламя (Flames)**: Вы танцуете с огнем и делаете все возможное, чтобы он не опалил вас.
...
В отличие от других заклинаний фокусировки, заклинания-откровения имеют признак "проклятое".
Этот признак значит, что когда они колдуются, то увеличивают степень вашего проклятья оракула (см. далее).
Вы не можете сотворять заклинания с признаком "проклятое" если у вас нет проклятия оракула.
...
Например, если ваше проклятие сделает существ "скрытыми" от вас, то вы никак не можете нивелировать это состояние "скрыт" с помощью магического предмета или заклинания, таких как :ref:`spell--t--True-Strike` (хотя вы все еще получите преимущества от других эффектов этого предмета или заклинания).
...
Ваши уровни мастерства с простым оружием и безоружными атаками увеличивается до эксперта.
...
Если вы сотворяете заклинание-откровение находясь под эффектами неимоверного проклятия, то вы подавлены проклятием и сохраняете состояние "обречен 2" даже если "Сфокусировались".
...
На 1-м уровне вы выбираете 1 начальное заклинание домена, из одного из этих доменов, которое вы можете колдовать как заклинание-откровение с признаком "проклятое".
...
Возможно, вы происходите из культуры с сильными наследственными традициями, такими как Шоанти Скон-Куа (Клан Черепа), традиционной общины дварфов, которая поклоняется семейному пантеону :ref:`Торага <Deity--Torag>`, или группа, которая почитает :ref:`Эрастила <Deity--Erastil>` или :ref:`Фаразму <Deity--Pharasma>`.
Вы можете общаться с могущественными психопомпами, которые провожают души в загробную жизнь, с самой "Рекой душ (River of Souls)" или теми духами, которые оказались в ловушке вне великого цикла духовного перерождения.
...
На 13-м уровне, если вы получаете особенность класса "Опыт с легкими доспехами", то еще вы получаете мастерство эксперта и с этими доспехами.

Выберите одну группу оружия, которая воплощает ваше таинство.
Вы обучены обращению со всем воинским оружием этой группы.
На 11-м уровне, если вы получаете особенность класса "Опыт с оружием", то еще вы получаете мастерство эксперта воинского оружия выбранной группы и становитесь обучены улучшенному оружию этой группы.
...
От вас едва пахнет сталью и кровью, как бы вы ни старались избавиться или замаскировать этот запах, вы кажетесь более мускулистым, чем есть на самом деле, и вы все время слышите вдалеке слабый звон и шум битвы.
...
Возможно, вы сами соприкоснулся со смертью, может быть даже умерли и вернулись к жизни, или носите в своей крови частичку нежити.
Если вы общаетесь с божествами, то можете говорить со стражами смерти, такими как :ref:`Фаразма (Pharasma) <Deity--Pharasma>` и психопомпы (самые могущественные среди существ, которые провожают души через загробную жизнь);
...
Вы получаете состояние "ослаблен 1" и получаете штраф -2 на спасброски и КС против :ref:`skill--Athletics--Grapple`, :ref:`skill--Athletics--Shove` и других видов принудительного перемещения.
...
Вы можете подавить свою ауру до начала вашего следующего хода, чтобы уменьшить пламя, не причиняя урона ни вам, ни кому-либо в ауре, тратя одиночное действие (|д-1|), которое получает признак "концентрация".
...
Когда вы завершаете сотворение заклинания не являющегося чарами, то восстанавливаете ОЗ равные уровню заклинания, на свой выбор, либо одной из целей заклинания, либо ближайшему к вас существу.
Вы не можете исцелить себя таким образом.
Это исцеление имеет признаки "некромантия", "позитивное" и "исцеление", а также признак магического обычай заклинания.
...
Вместо этого, вы теряете удвоенное количество ОЗ, которые выпали бри броске заклинания *исцеления*.
...
Вы можете понимать все языки, но вы не можете говорить, использовать эффекты с признаком "языковой" или иным образом общаться со своими союзниками.
Если вы совершаете :ref:`action--Cast-a-Spell` со словесной компонентой, то должны успешно пройти чистую проверку с КС 5, иначе заклинание теряется.
Вы получаете бонус состояния +4 к спасброскам против эффектов с признаком "языковой".
...
Когда вы наносите физический урон заклинанием с признаком "воздух" или "вода", не являющимся чарами, то наносите дополнительные 1 урона электричеством за уровень заклинания.
...
Это применяется во время того как вы :ref:`Ищите (Searching) <expl-activity--Search>`, используете :ref:`Поиск (Seeking) <action--Seek>` и при автоматической тайной проверке, которую вы получаете во время исследования, даже если не :ref:`Ищите (Searching) <expl-activity--Search>`.
...
В зависимости от того, используете вы жесты или голос, это действие получает признак либо "визуальное", либо "слуховое" соответственно.
...
Если ваше следующее действие - сотворять чары оракула или заклинание оракула, которое хотя бы на 2 уровня ниже, чем имеющийся у вас наивысший слот заклинания оракула, снизьте количество действий для его сотворения на 1 (до минимум 1 действия).
...
Когда вы делаете :ref:`action--Seek`, то получаете преимущества *обнаружения магии* 3-го уровня для того что вы видите (в дополнение к обычным преимуществам :ref:`Поиска (Seeking) <action--Seek>`).
...
Дополнительно, если заклинание включает атаку заклинанием или осуществление спасброска, то существа по которым вы попали или которые провалили свои спасброски, получают состояние "заворожен" на вас, до начала вашего следующего хода.
...
Когда вы сотворяете заклинание 5-го уровня или ниже, которое не имеет продолжительности, вместо того, чтобы тратить слот заклинания, вы можете усилить эффекты вашего проклятия оракула, таким же образом, как и когда колдуете заклинание-откровение.
...
Каждый день, во время ваших ежедневных приготовлений, вы можете выбрать 1 начальное или улучшенное доменное заклинание из любого домена "Основной книги правил (CRB)" или другого домена к которому у вас есть доступ, или любому начальному или продвинутому заклинанию-откровению другого таинства.
