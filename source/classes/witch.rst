...
**Примечание переводчика**: Все "Расширения заклинания" из CRB имеют признак "воздействие".
В книге APG у ведьмы указан "концентрация", но в `AoN <https://2e.aonprd.com/Feats.aspx?ID=315>`_ указана общая способность с "воздействием", как и у оракула из APG.
