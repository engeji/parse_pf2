...
Дополнительно, когда вы колдуете :ref:`spell--focus--Cackle` для поддержания сглаза, то получете эффекты :ref:`action--Sustain-a-Spell` для всех ваших активных сглазов, которые имеют поддерживаемую продолжительность.
