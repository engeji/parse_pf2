...
.. sidebar:: hidden
	...
	Обучен с коротким мечем, длинным мечем, рапирой, хлыстом, мягкой дубинкой, коротким луком
...
Вы становитесь экспертом в обращении с простым оружием, безоружными атаками, а так же длинным мечем, рапирой, коротким мечем, мягкой дубинкой, хлыстом и коротким луком.
...
.. sidebar:: Ключевые термины
	...
	**Композиция**: Чтобы сотворять чары-композицию или заклинание фокусировки, вы используете :ref:`skill--Performance`.
	Если заклинание включает слуховой компонент, вы должны использовать слуховой выступление, а если включает жестовый компонент, то должны использовать визуальное.
