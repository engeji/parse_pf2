...
В качестве альтернативы, вы можете увеличить количество действий спровоцировавшей :ref:`Ярости (Rage) <class-feature--Barbarian--Rage>` до 2 (|д-2|), чтобы использовать активность за 2 действия с признаком :t_rage:`ярость`.
...
Ваше действие :ref:`class-feature--Barbarian--Rage` получает признак :t_primal:`природный`, :t_transmutation:`трансмутация` и :t_morph:`трансформация`.
...
Когда вы в ярости, одно готовое существо в пределах 30 футов получает эффекты действия :ref:`class-feature--Barbarian--Rage`, кроме того, что он все еще может использовать действия с признаком :t_concentrate:`концентрация`.
...
| **Провал**: Цель потрясена и едва может говорить. Она получает состояние "ошеломлен 1" и ее речь хриплая и трудная для понимания. До конца своего следующего хода, она должна успешно пройти чистую проверку с КС 11, чтобы использовать действия с признаком :t_linguistic:`языковой` или обеспечить словесные компоненты для колдовства.
