...
Вы получаете бонус состояния +1 к КБ вместо получения штрафа -1 к КБ;
если у вас есть особенность класса :ref:`class-feature--Barbarian--Greater-Juggernaut`, то этот бонус состояния увеличивается до +2.
