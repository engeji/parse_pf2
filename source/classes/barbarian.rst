...
Когда при броске спасброска Стойкости вы получаете провал, против эффекта наносящего урон, то снижаете урон наполовину.
...
Если вы это делаете, то ваше действие "Ярость" получает признаки "аркана" и "разрушение", а так же признак соответствующий виду урона.
...
Вы сопротивляетесь дробящему урону и на ваш выбор холоду, электричеству или огню; вы выбираете когда получаете "Яростное сопротивление".
...
.. versionchanged:: /errata-r2
	Перефразировано. Стали четко прописаны расстояния, чтобы избежать нежелательных взаимодействий с другими возможностями, при этом сохраняя получаемые преимущества.
...
Толщина вашей шкуры дает вам ограничение модификатора Ловкости к КБ равное +3.
Этот бонус предмета к КБ складываются с :ref:`item--Armor-Potency` на вашей одежде исследователя, с :ref:`spell--m--Mage-Armor` и :ref:`item--Bracers-of-Armor`.
