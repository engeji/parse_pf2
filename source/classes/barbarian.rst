...
Вы можете использовать :ref:`class-feature--Barbarian--Rage` не ожидая 1 минуту после предыдущей Ярости (или 1 раунд, если у вас есть особенность класса :ref:`class-feature--Barbarian--Quick-Rage`), но когда заканчивается вторая Ярость, вы получаете состояние :c_fatigued:`утомлен`, пока не отдохнете 10 минут.
...
**Заметка (PFS)**: Когда используется против заклинания, которое не имеет указанного КБ, то Удар автоматически попадает, варвар просто делает бросок на проверку противодействия.
