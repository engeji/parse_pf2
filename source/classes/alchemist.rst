...
Эти предметы имеют признак "насыщенный" и остаются эффективными в течение 24 часов, или до ваших следующих дневных приготовлений, в зависимости от того, что произойдет раньше.
...
Когда вы используете :ref:`class-feat--Alchemist--Merciful-Elixir`, то вместо этого ваши эликсиры могут противодействовать состояниям "слепота", "глухота", "тошнота" и "замедлен".
