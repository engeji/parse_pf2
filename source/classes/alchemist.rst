...
При использовании :ref:`class-feat--Alchemist--Debilitating-Bomb` добавьте следующие состояния к списку, из которого вы можете выбирать: "неуклюжесть 1", "ослаблен 1", "одурманен 1" или штраф состояния к Скоростям -10.
...
**Триггер**: Вы создаете :ref:`item--Elixir-of-Life` с помощью :ref:`class-feature--Alchemist--Quick-Alchemy` и он бы на 2 уровня ниже вашего уровня продвинутой алхимии
