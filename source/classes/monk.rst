...
.. table:: Таблица 3-13-1: Удары в стойках
	...
	+=====================+============+========+=================================+
	| Крыло журавля       | 1d6 Д      | драка  | :w_agile:`быстрое`,             |
	| (Crane Wing)        |            |        | :w_finesse:`точное`,            |
	|                     |            |        | :w_nonlethal:`несмертельное`,   |
	|                     |            |        | :w_unarmed:`безоружное`         |
	+---------------------+------------+--------+---------------------------------+
	| Хвост дракона       | 1d10 Д     | драка  | :w_backswing:`обратный замах`,  |
	| (Dragon Tail)       |            |        | :w_nonlethal:`несмертельное`,   |
	|                     |            |        | :w_unarmed:`безоружное`         |
	+---------------------+------------+--------+---------------------------------+
	| Падающий камень     | 1d8 Д      | драка  | :w_forceful:`силовое`,          |
	| (Falling Stone)     |            |        | :w_nonlethal:`несмертельное`,   |
	|                     |            |        | :w_unarmed:`безоружное`         |
	+---------------------+------------+--------+---------------------------------+
	| Пасть волка         | 1d8 К      | драка  | :w_agile:`быстрое`,             |
	| (Wolf Jaw)          |            |        | :w_finesse:`точное`,            |
	|                     |            |        | :w_backstabber:`предательское`, |
	|                     |            |        | :w_nonlethal:`несмертельное`,   |
	|                     |            |        | :w_unarmed:`безоружное`         |
	+---------------------+------------+--------+---------------------------------+
	| Коготь тигра        | 1d8 Р      | драка  | :w_agile:`быстрое`,             |
	| (Tiger Claw)        |            |        | :w_finesse:`точное`,            |
	|                     |            |        | :w_nonlethal:`несмертельное`,   |
	|                     |            |        | :w_unarmed:`безоружное`         |
	+---------------------+------------+--------+---------------------------------+
	| Железный размах     | 1d8 Д      | драка  | :w_sweep:`размах`,              |
	| (Iron Sweep)        |            |        | :w_parry:`парирование`,         |
	|                     |            |        | :w_nonlethal:`несмертельное`,   |
	|                     |            |        | :w_unarmed:`безоружное`         |
	+---------------------+------------+--------+---------------------------------+
	| Извивающаяся ветвь  | 1d8 Р      | драка  | :w_agile:`быстрое`,             |
	| (Lashing Branch)    |            |        | :w_finesse:`точное`,            |
	|                     |            |        | :w_nonlethal:`несмертельное`,   |
	|                     |            |        | :w_unarmed:`безоружное`         |
	+---------------------+------------+--------+---------------------------------+
	| Грохот ветра        | 1d6 Р      | драка  | :w_agile:`быстрое`,             |
	| (Wind Crash)*       |            |        | :w_propulsive:`тяговое`,        |
	|                     |            |        | :w_nonlethal:`несмертельное`,   |
	|                     |            |        | :w_unarmed:`безоружное`         |
	+---------------------+------------+--------+---------------------------------+
	| Удары гориллы       | 1d8 Д      | драка  | :w_forceful:`силовое`,          |
	| (Gorilla Slam)      |            |        | :w_backswing:`обратный замах`,  |
	| :sup:`APG`          |            |        | :w_grapple:`захват`,            |
	|                     |            |        | :w_nonlethal:`несмертельное`,   |
	|                     |            |        | :w_unarmed:`безоружное`         |
	+---------------------+------------+--------+---------------------------------+
	| Спотыкающийся замах | 1d8 Д      | драка  | :w_agile:`быстрое`,             |
	| (Stumbling Swing)   |            |        | :w_finesse:`точное`,            |
	| :sup:`APG`          |            |        | :w_backstabber:`предательское`, |
	|                     |            |        | :w_nonlethal:`несмертельное`,   |
	|                     |            |        | :w_unarmed:`безоружное`         |
	+---------------------+------------+--------+---------------------------------+
	| Клык кобры          | 1d4 яд     | драка  | :w_agile:`быстрое`,             |
	| (Cobra Fang)        |            |        | :w_finesse:`точное`,            |
	| :sup:`APG`          |            |        | :w_deadly:`смертельное` d10,    |
	|                     |            |        | яд,                             |
	|                     |            |        | :w_nonlethal:`несмертельное`,   |
	|                     |            |        | :w_unarmed:`безоружное`         |
	+---------------------+------------+--------+---------------------------------+
	| Теневая хватка      | 1d4        | драка  | :w_agile:`быстрое`,             |
	| (Shadow Grasp)*     | негативный |        | :w_reach:`длинное`,             |
	| :sup:`APG`          |            |        | :w_grapple:`захват`,            |
	|                     |            |        | :w_unarmed:`безоружное`         |
	+---------------------+------------+--------+---------------------------------+
...
Она наносит 1d4 урона ядом, относится к группе "драка", и имеет признаки :w_agile:`быстрое`, :w_finesse:`точное`, :w_deadly:`смертельное` d10, "яд", :w_nonlethal:`несмертельное` и :w_unarmed:`безоружное`.
