...
**Требования**: Вы владеете мечем, в одной руке, который имеет признак "монах"
...
Раз в раунд, после того, как вы попадаете Ударом монашеским мечем, то своим следующим действием можете сделать :ref:`action--Step` в качестве свободного действия (|д-св|).
...
Этот Удар должен быть сделан мечем, требуемым для "Стойки павлина".
