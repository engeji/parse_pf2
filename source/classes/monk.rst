...
.. table:: Таблица 3-13-1: Удары в стойках
	...
	+=====+=====================+============+========+=================================+
	|   1 | Крыло журавля       | 1d6 Д      | драка  | :w_agile:`быстрое`,             |
	|     | (Crane Wing)        |            |        | :w_finesse:`точное`,            |
	|     |                     |            |        | :w_nonlethal:`несмертельное`,   |
	|     |                     |            |        | :w_unarmed:`безоружное`         |
	+-----+---------------------+------------+--------+---------------------------------+
	|   1 | Хвост дракона       | 1d10 Д     | драка  | :w_backswing:`обратный замах`,  |
	|     | (Dragon Tail)       |            |        | :w_nonlethal:`несмертельное`,   |
	|     |                     |            |        | :w_unarmed:`безоружное`         |
	+-----+---------------------+------------+--------+---------------------------------+
	|   1 | Падающий камень     | 1d8 Д      | драка  | :w_forceful:`силовое`,          |
	|     | (Falling Stone)     |            |        | :w_nonlethal:`несмертельное`,   |
	|     |                     |            |        | :w_unarmed:`безоружное`         |
	+-----+---------------------+------------+--------+---------------------------------+
	|   1 | Пасть волка         | 1d8 К      | драка  | :w_agile:`быстрое`,             |
	|     | (Wolf Jaw)          |            |        | :w_finesse:`точное`,            |
	|     |                     |            |        | :w_backstabber:`предательское`, |
	|     |                     |            |        | :w_nonlethal:`несмертельное`,   |
	|     |                     |            |        | :w_unarmed:`безоружное`         |
	+-----+---------------------+------------+--------+---------------------------------+
	|   1 | Коготь тигра        | 1d8 Р      | драка  | :w_agile:`быстрое`,             |
	|     | (Tiger Claw)        |            |        | :w_finesse:`точное`,            |
	|     |                     |            |        | :w_nonlethal:`несмертельное`,   |
	|     |                     |            |        | :w_unarmed:`безоружное`         |
	+-----+---------------------+------------+--------+---------------------------------+
	|   1 | Удары гориллы       | 1d8 Д      | драка  | :w_forceful:`силовое`,          |
	|     | (Gorilla Slam)      |            |        | :w_backswing:`обратный замах`,  |
	|     | :sup:`APG`          |            |        | :w_grapple:`захват`,            |
	|     |                     |            |        | :w_nonlethal:`несмертельное`,   |
	|     |                     |            |        | :w_unarmed:`безоружное`         |
	+-----+---------------------+------------+--------+---------------------------------+
	|   1 | Спотыкающийся замах | 1d8 Д      | драка  | :w_agile:`быстрое`,             |
	|     | (Stumbling Swing)   |            |        | :w_finesse:`точное`,            |
	|     | :sup:`APG`          |            |        | :w_backstabber:`предательское`, |
	|     |                     |            |        | :w_nonlethal:`несмертельное`,   |
	|     |                     |            |        | :w_unarmed:`безоружное`         |
	+-----+---------------------+------------+--------+---------------------------------+
	|   1 | Текучая волна       | 1d6 Д      | драка  | :w_agile:`быстрое`,             |
	|     | (Flowing Wave)      |            |        | :w_finesse:`точное`,            |
	...
	|     |                     |            |        | :w_unarmed:`безоружное`         |
	+-----+---------------------+------------+--------+---------------------------------+
	|   1 | Сверкающая искра    | 1d8 Р      | драка  | :w_forceful:`силовое`,          |
	|     | (Flashing Spark)    |            |        | :w_sweep:`размах`,              |
	|     | :sup:`SOM`          |            |        | :w_nonlethal:`несмертельное`,   |
	|     |                     |            |        | :w_unarmed:`безоружное`         |
	+-----+---------------------+------------+--------+---------------------------------+
	|   4 | Клык кобры          | 1d4 яд     | драка  | :w_agile:`быстрое`,             |
	...
	|     |                     |            |        | :w_unarmed:`безоружное`         |
	+-----+---------------------+------------+--------+---------------------------------+
	|   8 | Железный размах     | 1d8 Д      | драка  | :w_sweep:`размах`,              |
	|     | (Iron Sweep)        |            |        | :w_parry:`парирование`,         |
	|     |                     |            |        | :w_nonlethal:`несмертельное`,   |
	|     |                     |            |        | :w_unarmed:`безоружное`         |
	+-----+---------------------+------------+--------+---------------------------------+
	|   8 | Извивающаяся ветвь  | 1d8 Р      | драка  | :w_agile:`быстрое`,             |
	|     | (Lashing Branch)    |            |        | :w_finesse:`точное`,            |
	|     |                     |            |        | :w_nonlethal:`несмертельное`,   |
	|     |                     |            |        | :w_unarmed:`безоружное`         |
	+-----+---------------------+------------+--------+---------------------------------+
	|   8 | Грохот ветра        | 1d6 Р      | драка  | :w_agile:`быстрое`,             |
	|     | (Wind Crash) \*     |            |        | :w_propulsive:`тяговое`,        |
	|     |                     |            |        | :w_nonlethal:`несмертельное`,   |
	|     |                     |            |        | :w_unarmed:`безоружное`         |
	+-----+---------------------+------------+--------+---------------------------------+
	|   8 | Теневая хватка      | 1d4        | драка  | :w_agile:`быстрое`,             |
