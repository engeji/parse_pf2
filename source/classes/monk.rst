...
Вы принимаете стойку плавной грации, а во время ваших движений а атак вас обтекает небольшое количество воды.
Вы можете совершать атаки текучей волны, наносящие 1d6 дробящего урона.
Они относятся к группе "драка" и обладают признаками :w_agile:`быстрое`, :w_finesse:`точное`, :w_trip:`опрокидывание`, :w_disarm:`разоружение`, :w_unarmed:`безоружное`, :w_nonlethal:`несмертельное` и :t_water:`вода`.

Когда вы в этой стойке, то получаете бонус обстоятельства +1 к проверкам Атлетики для :ref:`skill--Athletics--Disarm`, :ref:`skill--Athletics--Trip` или :ref:`skill--Athletics--Swim`, а также бонус обстоятельства +2 к КС Рефлекса для избежания Разоружения и Опрокидывания.
...
Вы можете совершать атаки сверкающий искры, которые наносят 1d8 рубящего урона.
...
Находясь в этой стойке, вы получаете бонус состояния +5 футов к Скорости.
...
Когда вы в :ref:`class-feat--Monk--Stoked-Flame-Stance`, то у вас есть сопротивление холоду и огню равное половине вашего уровня, и любое существо, которое попадает по вам безоружной атакой, пытается :ref:`cr_ability--Grab` или :ref:`skill--Athletics--Grapple` вас, или как-либо иначе касается вас, получает огненный урон, равный вашему модификатору Мудрости (минимум 1).
...
**Требования**: Вы в :ref:`class-feat--Monk--Reflective-Ripple-Stance`
...
**Требования**: Вы в :ref:`class-feat--Monk--Stoked-Flame-Stance`
