...
Вы можете колдовать арканные заклинания используя активность :ref:`action--Cast-a-Spell`, и при колдовстве можете использовать материальные, жестовые и словесные компоненты (смотрите :ref:`ch7--Casting-Spells`).
...
Чары автоматически усиливаются до половины вашего уровня, округленного до большего целого, что обычно равняется самому высокому имеющемуся уровню слота заклинания волшебника.
