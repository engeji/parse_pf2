...
.. versionchanged:: /errata-r1
	Изначально было написано то, что компаньон получает бонус обстоятельства +2 для броска инициативы Скрытностью.
...
Он не может делать :ref:`Удары (Strikes) <action--Strike>`, если он совершает бросок атаки или проверку другого навыка, то он использует ваш уровень как свой модификатор.
...
.. versionadded:: /errata-r2
	Уточнение про уровень фамильяра и то, что он не может делать Удары.
...
Если фамильяр имеет другое количество действий, то когда ему дают такую команду, он может вытащить один предмет за каждое имеющееся у него действие.
