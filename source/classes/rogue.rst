...
Пока вы в этой стойке, любые метательные оружия, которое вы используете для дистанционного :ref:`Удара (Strike) <action--Strike>`, чтобы нанести дробящий или рубящий урон, мгновенно возвращаются в вашу руку, что позволяет вам использовать их для дополнительного Удара.
