...
.. table:: Таблица 3-15: Развитие плута
	...
	|         | Способность навыка                                                     |
	+---------+------------------------------------------------------------------------+
	|       9 | :ref:`action--Rogue--Debilitating-Strike`,                             |
...
Пока вы в этой стойке, любое :w_thrown:`метательное` оружие, которое вы используете для дистанционного :ref:`Удара (Strike) <action--Strike>`, чтобы нанести дробящий или рубящий урон, мгновенно возвращаются в вашу руку, что позволяет вам использовать их для дополнительных Ударов.
