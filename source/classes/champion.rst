...
Пока вы в этой стойке, когда критически попадаете с помощью  :ref:`class-feat--Champion--Attack-of-Opportunity` спровоцированной действием с признаком "движение", то вы прерываете это действие.
...
.. versionchanged:: /errata-r2
	Из предварительных условий убраны "догматы добра" и "божественный союзник-щит", так как они и так нежны для :ref:`class-feat--Champion--Shield-Warden`.
...
Вы получаете Скорость полета, равную вашей наземной Скорости.
Вы получаете ночное зрение, если у вас его не было, и получаете признаки "бес" и другой, подходящий для вида служителя, которым вы стали (например дэймон, демон или дьявол).
...
Он получает признак "бес" и признак соответствующий виду служителя, которым он стал (как дэймон, демон или дьявол).
