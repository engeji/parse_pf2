...
Если вы становитесь невидимым когда кто-то может видеть вас, то вначале вы будете "спрятанным" для наблюдателя (вместо того чтобы быть сразу "необнаруженным"), пока не используете успешно :ref:`skill--Stealth--Sneak`, чтобы снова стать "необнаруженным".
Во время невидимости вы не можете стать "замеченным", разве что при помощи специальных умений или магии.
