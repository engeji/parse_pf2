...
.. sidebar:: Правила по продолжительному урону
	...
	* Действие для помощи может потребовать проверку навыка или другого броска, чтобы определить его эффективность.
	...
	Если вы получите более одного состояния продолжительного урона одного типа, большее значение заменит меньшее.
	Весь этот урон наносится одновременно, поэтому, если что-то реагирует на получение вами урона, это происходит только раз.
	Например, если вы :c_dying:`при смерти` с несколькими типами продолжительного урона, они единожды увеличивают значение состояния :c_dying:`при смерти`.
