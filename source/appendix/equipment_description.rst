...
После правильной настройки, для зарядки в него подходящего :w_thrown:`метательного` оружия, требуется 1 действие :ref:`action--Interact`.
...
Из-за потери :w_thrown:`метательное` признака, :ref:`item--Returning` и большинство других эффектов, позволяющих оружию вернуться, не работают; даже если запущенное оружие вернется, вам все равно придется зарядить его в устройство действием Взаимодействие, чтобы снова выстрелить им.
...
При нажатии на курок, корзина ускоряется позволяя вам совершать :ref:`Выстрелы (Strike) <action--Strike>` заряженной алхимической бомбой на большие расстояния.
...
Перезарядка заводного абордажного пистолета требует 3 действий :ref:`action--Interact`.
...
В зависимости от своего вида, заводные крылья также обладают различными спецэффектами.
