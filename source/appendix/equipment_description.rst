...
Играя на духовном сингере вы также получаете бонус предмет +1 к проверкам на обнаружение :t_haunt:`призрака` или :t_incorporeal:`бестелесной` :t_undead:`нежити`, и вы можете кидать проверку на обнаружение призрака, даже если не ведете его активного :ref:`Поиска (Searching) <expl-activity--Search>`, благодаря искажениям музыки духовного сингера.
...
Врачи утверждают, что он помогает от всего, начиная головной болью до изжогой, и заканчивая тошнотой и глухотой, и все это при простом и безболезненном лечении.
...
Фиолетовый луч работает как :ref:`item--Healers-Tools` и дает бонус предмета +2 к проверкам Медицины для :ref:`skill--Medicine--First-Aid`, :ref:`skill--Medicine--Treat-Disease`, :ref:`skill--Medicine--Treat-Poison` или :ref:`skill--Medicine--Treat-Wounds`.
