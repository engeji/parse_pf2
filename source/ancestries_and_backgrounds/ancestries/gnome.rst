...
Гномы чаще всего поклоняются божествам, которые ценят индивидуальность и природу, таким как :ref:`Кайдэн Кайлин <Deity--Cayden-Cailean>`, :ref:`Дезна <Deity--Desna>`, :ref:`Гозрей <Deity--Gozreh>` и :ref:`Шелин <Deity--Shelyn>`.
