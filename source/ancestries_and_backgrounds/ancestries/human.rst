...
После того, как вы :ref:`Помогли (Aid) <action--Aid>` союзнику с проверкой навыка, которая не имеет признака "атака", то вы так же можете :ref:`Помочь (Aid) <action--Aid>` любому другому союзнику, который в этом раунде совершает проверку того же навыка с той же целью.
