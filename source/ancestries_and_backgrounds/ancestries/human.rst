...
Существо, обманутое таким образом, не может получать преимущество от этого эмоционального эффекта и не может использовать умения, для которых требуется, чтобы вы были под действие этого эмоционального эффекта;
...
Эти старые магии позволяют вас с легкостью зачаровывать :t_construct:`конструктов`.
