...
Вы не можете колдовать заклинания с признаком :t_darkness:`тьма`, активировать предметы с признаком :t_darkness:`тьма` или использовать любые другие умения с признаком :t_darkness:`тьма`.
