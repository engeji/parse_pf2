...
Вы можете есть и пить когда имеете состояние :c_sickened:`тошнота`.
...
Вы всегда можете выбрать волка как животного компаньона, даже если будете выбирать зверя-компаньона с особенностью "ездовое животное", такого как :ref:`союзник-скакун <class-feature--Champion--Ally--Steed>` чемпиона.
...
Во время :ref:`skill--Acrobatics--Squeeze` вы получаете бонус обстоятельства +4 к вашим КС Стойкости и КС Рефлекса против попыток :ref:`skill--Athletics--Shove` вас, или иным образом сдвинуть вас с места.
...
Если при броске результат против цели был успешный, то вместо этого вы получаете критический успех.
...
Когда используете :ref:`ancestry-feat--Goblin--Goblin-Scuttle`, то вместо :ref:`action--Step`, можете сделать :ref:`action--Stride` вплоть до половины своей Скорости.
...
| **Критический успех**: Цель получает состояние :c_clumsy:`неуклюжесть 2` на 1 раунд
| **Успех**: Цель получает состояние :c_clumsy:`неуклюжесть 1` на 1 раунд
...
Ваш противник может переместить вас на расстояние вплоть до 30 футов по своему выбору, и в направлении по своему выбору (это не принудительное перемещение, и оно провоцирует реакции, как и обычное).
Вы падаете ничком и получаете состояние :c_stunned:`ошеломлен 1`.
...
Вы можете :ref:`skill--Stealth--Sneak` вплоть до вашей полной Скорости, и вам больше не надо иметь обычное или большое укрытие, или быть "скрытым" чтобы :ref:`skill--Stealth--Hide` или :ref:`skill--Stealth--Sneak`.
...
Эти преимущества применяются только к вредным эффектам, воздействиям которым вы подвергаетесь в свой ход, во время которого вы активировали "Безрассудный отказ", как например при прохождении через :ref:`spell--p--Prismatic-Wall`.
