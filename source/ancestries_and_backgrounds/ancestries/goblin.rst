...
Вы получаете бонус обстоятельства +2 к спасброскам против недугов, получения состояния "тошнота", и чтобы избавиться от состояния "тошнота".
Когда при броске при спасброска Стойкости, к которому применяется этот бонус, вы получаете успех, то вместо этого вы получаете крит.успех.
...
| **Критический провал**: Цель получает временный иммунитет к "Гоблинской песенке" на 1 час
