...
Когда вы в толпе или переполненной области города, вы можете попытаться использовать :ref:`skill--Stealth--Hide` и :ref:`skill--Stealth--Sneak`, даже когда имеете состояние :c_observed:`замечен`.
При успехе, вы не получаете состояние :c_concealed:`скрыт` или :c_undetected:`необнаружен`, но другие существа просто не обращают на вас особого внимания, даже если они могут видеть вас.
...
**Триггер**: Враг большого размера или больше закончил рядом с вами свое действие с признаком :t_move:`движение`
...
Вам больше не нужно укрытие или иметь состояние :c_concealed:`скрыт`, чтобы :ref:`skill--Stealth--Hide` и :ref:`skill--Stealth--Sneak`.
...
Находясь на открытом воздухе в городской среде, вы можете сделать :ref:`action--Step` на сложную местность, а враги в сложной местности для вас :c_flat_footed:`застигнуты врасплох`.
...
Пока не закончится ваша невидимость, для всех, кто пытается вас найти, кажется, что вы :c_concealed:`скрыты` в этом месте.
