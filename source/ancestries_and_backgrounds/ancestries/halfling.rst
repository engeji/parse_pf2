...
Когда при броске спасброска вы получаете успех против :t_emotion:`эмоционального` эффекта, то вместо этого получаете крит.успех.
...
Всякий раз, когда вы получаете особенность класса, которая дает вам уровень мастерства эксперта или выше, в определенном оружии или оружиях, вы также получаете этот уровень мастерства для короткого меча, пращи, посоха-пращи и всего оружия полуросликов с которым вы обучены.
...
**Триггер**: Вы успешно используете Скрытность, чтобы :ref:`skill--Stealth--Hide` и стать :c_hidden:`спрятанным` от всех своих текущих врагов, или использовали Скрытность, чтобы :ref:`skill--Stealth--Sneak` и стать :c_undetected:`необнаружены` для всех своих текущих врагов
