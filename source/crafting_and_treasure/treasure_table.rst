...
.. table:: Таблица 11-1-2-1: Расходуемые предметы 2-го ур.
	...
	+---------------------------------------------------------------------+-------------+-------+
	| :ref:`Пуддинг из драконьей крови (Dragon's blood pudding)           | расходуемый | 5 зм  |
...
.. table:: Таблица 11-1-17-2: Постоянные предметы 17-го ур.
	...
	+----------------------------------------------------------------------+--------------+------------+
	| :ref:`Брошь вдохновения, превосходная (Brooch of inspiration, major) | надеваемый   | 1.200 зм   |
	| <item--Brooch-of-Inspiration>` :sup:`Н` :sup:`LOGB`                  |              |            |
	+----------------------------------------------------------------------+--------------+------------+
...
.. table:: Таблица 11-1-18-2: Постоянные предметы 18-го ур.
	...
	+--------------------------------------------------------------------------+--------------+------------+
	| :ref:`Инубриксовый доспех, высококачественный                            | доспех       | 1.200+ зм  |
