...
.. table:: Таблица 11-1-4-1: Расходуемые предметы 4-го ур.
	...
	+------------------------------------------------------------------------+-------------+-------+
	| :ref:`Яд ступора (Stupor poison) <item--Stupor-Poison>` :sup:`Н`       | яд          | 16 зм |
	+------------------------------------------------------------------------+-------------+-------+
...
.. table:: Таблица 11-1-5-1: Расходуемые предметы 5-го ур.
	...
	+-------------------------------------------------------------------------------+------------+-------+
	| :ref:`Грибковый мускус (Fungal Walk Musk) <item--Universal-Solvent>`          | инструмент | 21 зм |
	+-------------------------------------------------------------------------------+------------+-------+
...
.. table:: Таблица 11-1-5-2: Постоянные предметы 5-го ур.
	...
	| <item--Rope-of-Climbing>`                                                   |              |         |
	+-----------------------------------------------------------------------------+--------------+---------+
	| :ref:`Складные барабаны (Folding drums)                                     | удерживаемый | 160 зм  |
	| <item--Folding-Drums>` :sup:`Н`                                             |              |         |
	+-----------------------------------------------------------------------------+--------------+---------+
