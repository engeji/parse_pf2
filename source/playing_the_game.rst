...
.. sidebar:: Игровые соглашения
	...
	Для примера, если одно свойство удваивает длительность заклинания, а другое так же удваивает его длительность, то вы утроите длительность, а не учетверите ее.
...
Например заклинание :ref:`spell--h--Heroism` уровня дает +1 бонус состояния к броскам атаки, проверкам Внимания, спасброскам и проверкам навыков.
