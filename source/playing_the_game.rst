...
Например, вы владеете длинным мечом в одной руке и коротким мечом (у которого есть признак "быстрое") в другой, и собираетесь совершить три :ref:`Удара (Strikes) <action--Strike>` этими оружиями во время хода.
