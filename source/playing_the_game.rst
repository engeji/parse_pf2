...
Броски атак заклинаниями работают немного по другому и будут описаны отдельно далее.
...
Однако, если оно получает тип урона указанный в описании регенерации, то его регенерация не работает до конца его следующего хода, в том числе для спровоцировавшего урона.
