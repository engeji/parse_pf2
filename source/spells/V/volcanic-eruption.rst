...
Лава быстро остывает и захватывает собою существ в области.
Существо, захваченное в камне получает состояние :c_clumsy:`неуклюжесть 1` и штраф состояния -10 футов к Скоростям.
...
Существа, заключенные в камне, могут попытаться :ref:`action--Escape` используя ваш КС заклинания, чтобы завершить этот эффект.
