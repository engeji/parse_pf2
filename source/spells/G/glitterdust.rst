...
| **Провал**: Цель получает состояние "ослеплен" на 1 минуту и ее невидимость отменена на 1 минуту
| **Критический провал**: Цель получает состояние "слепота" на 1 раунд и "ослеплен" на 10 минут. Ее невидимость отменена на 10 минут.
