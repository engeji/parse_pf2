...
| **Стадия 1**: Состояние "тошнота 1" (1 раунд)
| **Стадия 2**: Состояния "тошнота 1" и "замедлен 1" (1 раунд)
| **Стадия 3**: Состояние "тошнота 1" и существо не может снизить значение "тошноты" ниже 1 (1 день)
