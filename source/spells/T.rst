...
| **Провал**: Цель получает штраф обстоятельства -10 футов к Скорости и не может уйти дальше чем на 30 футов от вас, пока не сможет :ref:`action--Escape` или заклинание закончится.
| **Критический провал**: Цель получает состояние "обездвижен" пока не сможет :ref:`action--Escape` или заклинание не завершится.
