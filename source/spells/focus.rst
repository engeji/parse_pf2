...
.. _spell--focus--Oathkeeper-Insignia:

Эмблема хранителя клятвы (`Oathkeeper Insignia <https://2e.aonprd.com/Spells.aspx?ID=604>`_) / Фокус. 1
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
**Заметка**: В оригинале отсутствует признак заклинания "атака", а он там должен быть. Источник - https://www.reddit.com/r/Pathfinder2e/comments/ezot7c/godsmagic_typos/
...
В первый раз, когда существо начинает свой ход в этой области или входит в нее, оно должно совершить спасбросок Воли.
Если он позже покидает и возвращается в область действия, он использует тот же эффект, что и раньше.
...
| **Провал**: Пока существо находится в этой области, любые эффекты "эмоций" более низкого уровня противодействия, чем *переполненная скорбь*, подавляются, и всякий раз, когда существо пытается использовать действие или наложить заклинание с признаком "эмоция", оно должно преуспеть в чистой проверке с КС 11, иначе действие или заклинание будет нарушено
| **Критический провал**: Как провал, но существо не может использовать действия или накладывать заклинания с признаком "эмоция"

----------

**Усиление (+2)**: Когда вы выполняете :ref:`action--Cast-a-Spell`, вы можете увеличить площадь на 5 футов.
...
| **Успех**: Цель невредима
| **Провал**: Цель "ошеломлена 1", так как ее душа на короткое время теряют связь со своим телом
| **Критический провал**: Душа цели покидает свое тело на 1 раунд. Тело жертвы "ошеломлено". В то время тело "ошеломлено" таким образом, цель остается полностью осознанной в форме души; она просто не может сознательно двигать своим телом (хотя тело совершает основные инстинктивные защитные движения). Душа цели получает признак "бестелесное", невидима и имеет Скорость полета 60 футов. Душа не может атаковать, накладывать заклинания или совершать проверки  каких-либо навыков, которые требуют физического тела, и она всегда должна поддерживать линию эффекта со своим телом. Когда тело цели перестает быть "ошеломленным", душа цели мгновенно возвращается в свое тело, когда цель просыпается.
...
В *эктоплазматическом промежутке* бестелесные существа не могут проходить через твердые объекты или телесных существ, и они могут манипулировать и совершать проверки связанные с Силой против физических существ и объектов.
Бестелесный ИП или другое существо с нормальным модификатором Силы просто использует этот модификатор, но если у существа был модификатор Силы -5, как у большинства бестелесных существ, оно использует вместо этого модификатор +4, увеличивая свой модификатор Атлетики на 9, соответственно.
Атаки против существ, которые находятся в промежутке, преодолевают сопротивление, как если бы они были оружием с руной *призрачного касания*.
...
| **Критический успех**: Цель невредима
| **Успех**: Цель "ослеплена" на 1 раунд
| **Провал**: Цель "ослеплена" на 1 раунд. Пока заклинание продолжается и пока вы можете видеть ночное небо и цель видима под этим ночным небом, вы можете определить приблизительное направление и расстояние до существа, используя одно действие, имеющее признак "концентрация". Это достаточно точно, чтобы выследить существо, но не определить его точный квадрат (например, чтобы совершить атаку). Вы можете установить количество *звезд в зените*, равное вашему модификатору Мудрости, если вы превысите это число, ваша самая старая *звезда в зените* автоматически будет :ref:`Рассеяна (Dismissed) <action--Dismiss>`.
| **Критический провал**: Как провал, но цель "слепа" на 1 раунд.

----------

**Усиление (+2)**: Продолжительность увеличивается на 1 день.

**Усиление (4-й)**: Вы игнорируете состояние "скрыт" против целей, отмеченных *звездой над головой*.
...
Начертите пять линий по одной за раз; каждая линия должна быть привязана к вам или существу или объекту уже соединенному с предыдущей линией, и она должна заканчиваться на существе или объекте в пределах 30 футов от его якоря (что может позволить астеризму расшириться до полной 150-футовой дистанции).
Существо, которое начинает свой ход в одной из этих линий или входит в одну из этих линий на своем ходу, получает 4d6 урона огнем (простой спасбросок Рефлексов).
Существо может получить этот урон только один раз за ход, даже если оно движется через несколько линий.
Цели, входящие в состав астеризма, не получают от него урона.
Если расстояние между двумя целями (или вами и целью) когда-либо превышает 30 футов, линия звездного света между ними разрывается, и любые линии, которые больше не имеют прямого пути к вам, также разрываются.
Вы можете :ref:`action--Dismiss` заклинание.
...
**Использование**: одна минута (жестовый, словесный)
...
Вы можете слышать через рой, как если бы использовали свои обычные слуховые органы.
В первый раз, когда вы :ref:`action--Sustain-a-Spell` каждый раунд, вы можете перемещать рой на 10 футов по земле в любоым направлении.
Рой имеет 15 КБ и +0 к спасброскам.
Любой урон, нанесенный рою, уничтожает его и прекращает действие заклинания.

----------

**Усиление (3-й)**: Рой получает преимущества *паучьих лап*
...
Находясь в форме роя, у вас есть признак "рой", и вы получаете сопротивление 5 к рубящему и колющему урону, и слабость 5 к урону по площади и брызгов.
...
Вы не приобретаете умение разума роя, поэтому вы все еще подвержены нормальному воздействию "ментальных" эффектов.
Как рой, вы не можете говорить, накладывать заклинания, использовать манипуляции требующие ваших рук, активировать свои магические предметы или наносить Удары своего обычного тела.
Вы можете :ref:`action--Dismiss` заклинание
...
Последствия задержки (`Delay Consequence <https://2e.aonprd.com/Spells.aspx?ID=622>`_) / Фокус. 1
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
**Цели**: 1 существо или объекты до 1 Массы
...
**Заметка**: В оригинале неправильно указан спасбросок, для этого заклинания применяется спасбросок Воли. Источник - https://www.reddit.com/r/Pathfinder2e/comments/ezot7c/godsmagic_typos/
...
Если вы прикасаетесь к оружию, ваш ранг мастерства с этим оружием временно увеличивается до обученного (если он еще не выше).
Если вы прикоснетесь к инструменту, ваш ранг мастерства при следующей проверке навыка, которую вы попытаетесь выполнить с помощью этого инструмента (например проверка Ремесла с помощью кузнечного молота), в течение продолжительности заклинания временно увеличивается до обученного (если оно еще не выше).
Это заклинание не имеет никакой пользы для действий, которые занимают больше минуты.
...
Вспомнить потерянное (`Remember the Lost <https://2e.aonprd.com/Spells.aspx?ID=625>`_) / Фокус. 4
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
Пустота внутри (`Empty Inside <https://2e.aonprd.com/Spells.aspx?ID=626>`_) / Фокус. 1
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
Воздух устремляется сквозь трещины, притягивая к центру Больших или меньших существ и объекты легкой Массы или меньше.
Большие или меньшие существа в этой области должны совершить спасбросок Стойкости в начале своего хода; существа, которые перемещаются в эту область должны совершить спасбросок при входе.
...
Конкретный дракон является случайным, бросьте 1d6 по таблице ниже для каждого вызванного дракона, чтобы определить, какой тип дракона вы создаете.
...
Этот дистанционный Удар использует ваш бонус атаки заклинания и наносит 1d6 урона плюс ваш модификатор колдовской характеристики, с видом урона в зависимости от дракона.
Удар дыхания дракона использует и вносит свой вклад в ваш штраф множественной атаки.
Как только дракон использовал свой Удар дыханием, он исчезает; когда у вас не осталось драконов, заклинание заканчивается.

.. table:: Драконий залп

	+------+-------------------------------+---------------+
	|  D6  |        Дыхание дракона        |   Тип Удара   |
	+======+===============================+===============+
...
Впечатляющие рев дает вам бонус обстоятельства +2 к проверкам Дипломатии в течение 10 минут против драконов, которые были в области заклинания во время накладывания.
...
*Рев дракона* влияет на не-драконьих существ с глубокими связями с драконьим родом (например, варвар с драконьим инстинктом, чародей с драконьей родословной или член культуры, которая почитает драконов), как если бы они имели признак "дракон".
