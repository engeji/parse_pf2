...
Каждая цель должна пройти испытание Воли.
Независимо от результата испытания, каждая цель потом временно иммунна на 1 минуту.
...
Вы снижаете уровень заклинания на 1, и его цели получают бонус состояния +2 к испытаниям, проверкам навыков, КБ или КС против него.
...
**Испытание**: простой Рефлекс или Стойкость

----------

Вы извергаете энергию изо рта, нанося 5d6 повреждений.
Область, тип повреждений и испытания зависят от вида дракона вашего наследия.

.. table:: Виды драконов и типы повреждений
	
	+----------------------+--------------------------------+-----------+
	|     Вид дракона      |   Область и тип повреждений    | Испытание |
	+======================+================================+===========+
...
Это причиняет 3d4 негативных повреждений; цель должна пройти простое испытание Стойкости.
Вы получаете временные Очки Здоровья в количествен нанесенных цели повреждений, после прохождения испытания и применения вашей магии крови, если применимо.
...
| **Неудача**: Существо не может использовать реакции и получает штраф состояния -2 на проверки Восприятия и испытания Воли.
| **Критическая неудача**: Как неудача, и существо так же получает штраф состояния -1 на проверки Восприятия и испытания Воли на 1 минуту.
...
Каждое существо в области должно пройти испытание Рефлекса.
...
Враги в области должны пройти испытание Воли.
...
В начале каждого вашего хода, цель может пройти другое испытание Воли, чтобы закончить эффект при успехе.
...
Болото причиняет 1d6 повреждений ядом; существа, которые заканчивают свой ход в этой области, должны пройти простое испытание Стойкости.
...
Если цели желают избежать заклинания, они могут пройти испытание Воли чтобы снизить эффекты.
...
При крит.неудаче, цель под контролем до 1 минуты; она получает новое испытание Воли в конце каждого своего хода, и при успехе заклинание кончается.
...
Киньте d20; когда цель делает нетайные испытание или проверку навыка, она может использовать число, которое выбросили вы, вместо того чтобы бросать самому, и после этого заклинание заканчивается.
...
Цель получает бонус состояния +2 к следующей проверке Акробатики, Атлетики или испытанию Стойкости, Рефлекса.
