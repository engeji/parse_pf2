...
если цель - готовый союзник, он еще получает бонус состояния +2 к КБ на 1 раунд.
Нежить получает 1d6 урона и должна совершить простой спасбросок Стойкости, и если проваливает его, то получает штраф состояния -2 к КБ на 1 раунд.
...
Если цель живая, это наносит ей 1d6 негативного урона (простой спасбросок Стойкости); при провале спасброска, цель также получает штраф состояния -2 к КБ на 1 раунд.
...
Вы и все союзники в этой области получают бонус состояния +1 к проверкам Восприятия на обнаружение спрятанных или необнаруженных существ, а так же спрятанных объектов, дверей или других особенностей.
...
Вы должны владеть мечом или копьем, чтобы колдовать *солнечный клинок* и вы выполняете жестовый компонент заклинания с помощью этого оружия.
