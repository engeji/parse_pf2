...
| **Неудача**: Первый раз в течение продолжительности заклинания, когда цель делает бросок на атаку или проверку навыка, она должна бросить дважды и использовать худший результат.
