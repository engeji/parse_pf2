...
| **Провал**: Существо получает состояние "схвачен" от стены на 1 раунд, или пока не сможет :ref:`action--Escape` с вашим КС заклинания, в зависимости от того, что произойдет раньше
| **Критический провал**: Существо получает состояние "сдерживаем" от стены на 1 раунд, или пока не сможет :ref:`action--Escape` с вашим КС заклинания, в зависимости от того, что произойдет раньше
