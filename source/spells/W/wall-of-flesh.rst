...
| **Провал**: Существо на 1 раунд получает состояние "схвачен" от стены, или пока не сможет :ref:`action--Escape` с вашим КС заклинания, в зависимости от того, что произойдет раньше
| **Критический провал**: Существо на 1 раунд получает состояние "сдерживаем" от стены, или пока не сможет :ref:`action--Escape` с вашим КС заклинания, в зависимости от того, что произойдет раньше
