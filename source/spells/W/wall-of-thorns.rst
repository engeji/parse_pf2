...
За каждое действие с признаком "движение", которое существо использует, чтобы войти по крайней мере в одно из пространств стены, оно получает 3d4 колющего урона.
