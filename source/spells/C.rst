...
* **5. Синяя**: Стена останавливает проходящие через нее слуховые, визуальные и эффекты окаменения, а существа проходящие через нее становятся целью эффекта :ref:`spell--f--Flesh-to-Stone`. Синей стене противодействует :ref:`spell--m--Magic-Missile`.
