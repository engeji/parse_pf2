...
Когда вы :ref:`action--Cast-a-Spell`, ваше колдовство создает очевидные визуальные формы проявления сбора магии, хотя способности такие как :ref:`class-feat--Conceal-Spell` и :ref:`class-feat--Melodious-Spell` могут спрятать такие формы проявления или иным образом помешать наблюдателям заметить, что вы колдуете.
...
Некоторые заклинания ограничивают вам выбором готовых существ.
