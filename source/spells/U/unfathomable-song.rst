...
Каждая цель должна совершить спасбросок Воли когда вы используете заклинание и затем снова, когда вы каждый раунд впервые используете :ref:`action--Sustain-a-Spell`.
