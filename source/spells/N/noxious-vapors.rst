...
Существо, которое крит.проваливает спасбросок еще получает состояние :c_sickened:`тошнота 1`.
Все существа в области становятся :c_concealed:`скрытыми`, а все существа вне дыма становятся :c_concealed:`скрытыми` для существ находящихся внутри.
