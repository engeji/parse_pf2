...
* **Источники**: **CRB** - Core Rulebook (Основная книга правил); **APG** - Advanced Player's Guide (Продвинутое руководство игрока); **Bestiary #** - Бестиарии, где # это номер бестиария; **AP #** - Путь приключений, где # это номер журнала
...
| **1-й уровень**: Вампирский туман (Vampiric mist)
| **2-й уровень**: Скалатракс (Scalathrax)
| **3-й уровень**: Бормочущий ротовик (Gibbering mouther)
| **4-й уровень**: Блуждающий огонек (Will-o'-wisp)
| **5-й уровень**: Пожиратель душ (Soul eater)
| **6-й уровень**: Сгусток пустоты (Voidglutton)
| **7-й уровень**: Ужасающий рэйф (Dread wraith)
| **8-й уровень**: Привидение мага (Ghost mage)
| **9-й уровень**: Госрег (Gosreg)
| **10-й уровень**: Сияющее дитя (Shining Child)
