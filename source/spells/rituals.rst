...
.. table:: Таблица 7-2: Ритуалы по уровням
	...
	+---------+----------------------------------------------+------------+
	|       3 | :ref:`ritual--Awaken-Portal` :sup:`Р`        | AV         |
	+---------+----------------------------------------------+------------+
...
* **Источники**: **CRB** - Core Rulebook (Основная книга правил); **APG** - Advanced Player's Guide (Продвинутое руководство игрока); **Bestiary #** - Бестиарии, где # это номер бестиария; **AV** - Abomination Vaults (Своды Мерзости)
...
В то время как телепортационные круги и порталы, найденные в Сводах Мерзости, не требуют дополнительных затрат для пробуждения, другие порталы могут потребовать редкие предметы или специальные материалы в качестве платы за этот ритуал, по усмотрению Мастера - некоторые порталы могут быть настолько мощными, что этот ритуал не может пробудить их вообще.

КС необходимый для успешного пробуждения портала, зависит от силы и расстояния между его конечными точками. Для порталов, найденных в Abomination Vaults Adventure Path, КС варьируется в зависимости от уровня подземелья, на котором он расположен.
Используйте раздел КС по уровню заклинаний таблицы 10-5-2 на стр. 503 Основных Правил, чтобы определить КС для портала, используя уровень подземелья вместо уровня заклинания.
...
| **Критический провал**: Как провал, но кроме того, враждебное существо втягивается через портал и немедленно атакует любого присутствующего. Существо, проявившееся через портал, варьируется в зависимости от природы портала; в Сводах Мерзости появление существа зависит от уровня подземелья, где был предпринят ритуал, как указано ниже.

| **Первый уровень**: Вампирский туман (Vampiric mist)
| **Второй уровень**: Скалатракс (Scalathrax)
| **Третий уровень**: Бормочущий ротовик (Gibbering mouther)
| **Четвертый уровень**: Блуждающий огонек (Will-o'-wisp)
| **Пятый уровень**: Пожиратель душ (Soul eater)
| **Шестой уровень**: Сгусток пустоты (Voidglutton)
| **Седьмой уровень**: Ужасающее умертвие (Dread wraith)
| **Восьмой уровень**: Привидение мага (Ghost mage)
| **Девятый уровень**: Госрег (Gosreg)
| **Десятый уровень**: Дитя сияния (Shining Child)
