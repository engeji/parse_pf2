...
Пока длится заклинание, вы можете менять возраст на любой из трех или на свой настоящий, при помощи одиночного действия, которое имеет признак "концентрация".
