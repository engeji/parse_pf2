...
Вы получаете бонус состояния +1 к следующим проверка относительно духов и призраков: проверки Восприятия на :ref:`action--Seek`, попытки :ref:`skill--Recall-Knowledge`, проверки навыков для выяснения причины их существования, и проверки навыков, чтобы обезвредить призрак.
Вы также получаете бонус состояния +1 к КБ и спасброскам против духов и призраков.
