...
**Цели**: :c_petrified:`окаменевшее` существо или каменные объекты человеческого размера

----------

Манипулируя фундаментальными частицами материи, вы превращаете камень в плоть и кровь.
Вы возвращаете :c_petrified:`окаменевшее` существо в его нормальное состояние или превращаете каменный объект в массу инертной плоти (без Твердости камня) примерно такой же формы.
