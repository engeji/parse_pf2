...
Вы призываете обычное существо, которое имеет признак :t_animal:`животное` и чей уровень равен -1, из тех, что можно найти в томах :ref:`Бестиария <Creatures--Bestiary>`.
