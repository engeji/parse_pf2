...
| **13-й или ниже**: Цель получает состояние :c_stunned:`ошеломлен` на 1d6 раундов
| **14-й, 15-й**: Цель получает состояние :c_stunned:`ошеломлен` на 1 раунд
| **16-й или больше**: Цель получает состояние :c_stunned:`ошеломлен 1`
