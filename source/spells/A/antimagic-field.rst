...
Инвестированные магические предметы перестают функционировать, но они остаются инвестированными и возобновляют работу, когда покидают поле; повышение характеристики от наивысшего предмета не подавляется внутри поля.
