...
Последователи вашей веры игнорируют состояние цели :c_concealed:`скрыт`, если оно есть, и цель получает штраф состояния -1 к КБ против атак последователей вашей веры.
