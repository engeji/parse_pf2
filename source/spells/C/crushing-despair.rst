...
| **Успех**: На 1 раунд существо не может использовать реакции и должно совершить еще один спасбросок в начале своего хода; при провале, на этот ход оно получает состояние :c_slowed:`замедлен 1`, так как оно безудержно рыдает
| **Провал**: Как успех, но продолжительность 1 минуту
| **Критический провал**: Как провал, и существо автоматически получает :c_slowed:`замедлен 1` на 1 минуту
