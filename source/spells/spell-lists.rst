...
:ref:`spell--Necromancers-Generosity` :sup:`У` :sup:`SOM` (нерк.): Исцеляет вашего миньон :t_undead:`нежить` и защищает его от :t_positive:`позитивной` энергии.
...
:ref:`spell--Ash-Cloud` :sup:`У` :sup:`SOM` (вопл.): Призывает облако горячего перла и дыма.
...
:ref:`spell--Lucky-Number` :sup:`SOM` (прориц.): Подготавливает сопряжение, чтобы перебросить определенный случайно выбираемый результат d20.
...
:ref:`spell--Phantom-Crowd` :sup:`У` :sup:`SOM` (иллюз.): Создаете иллюзорную толпу, которая громко соглашается с вами.

:ref:`spell--Scorching-Ray` :sup:`У` :sup:`SOM` (эвок.): Выпускает в разных врагов от 1 до 3 лучей тепла и пламени.

:ref:`spell--Summoners-Precaution` :sup:`SOM` (нерк.): Готовит сопряжение, чтобы избежать потери сознания вместе с эйдолоном.
...
:ref:`spell--Inner-Radiance-Torrent` :sup:`У` :sup:`SOM` (нерк.): Собирает духовную энергию, чтобы выпустить бурю силовых снарядов и лучей.

:ref:`spell--Instant-Armor` :sup:`SOM` (вопл.): Заготавливает в межпространственном кармане доспех на чрезвычайный случай.

:ref:`spell--Lucky-Number` :sup:`SOM` (прориц.): Подготавливает сопряжение, чтобы перебросить определенный случайно выбираемый результат d20.

:ref:`spell--Mimic-Undead` :sup:`SOM` (нерк.): Притворяетесь :t_undead:`нежитью`.
...
:ref:`spell--Thundering-Dominance` :sup:`У` :sup:`SOM` (очар.): Делает вашего эйдолона или фамильяра устрашающим, и позволяет ему издать рёв.
...
:ref:`spell--Feral-Shades` :sup:`У` :sup:`SOM` (нерк.): Конус теней в форме гончих разрывает существ.
