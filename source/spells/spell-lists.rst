...
:ref:`spell--Blazing-Dive` :sup:`У` :sup:`SOM` (эвок.): Взлетаете, а потом пикируете со взрывом перегретого воздуха.
...
:ref:`spell--Mind-Of-Menace` :sup:`SOM` (очар.): Устанавливает сопряженность, чтобы покарать врага за ментальный эффект и защитить вас. 
...
:ref:`spell--Mind-Of-Menace` :sup:`SOM` (очар.): Устанавливает сопряжение, чтобы покарать врага за ментальный эффект и защитить вас. 
