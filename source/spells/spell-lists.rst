...
:ref:`spell--d--Daydreamers-Curse` :sup:`Н` (очар.): Прокляните цель легкомысленностью.

:ref:`spell--s--Savants-Curse` :sup:`Н` (очар.): Прокляните цель отвлекающими сверхподробными деталями

:ref:`spell--c--Call-The-Blood` :sup:`Н` :sup:`У` (некр.): Вытяните кровь из цели и поглотите ее
...
:ref:`spell--e--Ectoplasmic-Expulsion` :sup:`Н` (некр.): Пошлите призрачную сущность противодействовать психическому эффекту воздействующему на цель.
