...
:ref:`spell--Gale-Blast` :sup:`У` :sup:`SOM` (эвок.): Наносит урон с помощью воздуха и отталкивает находящихся радом существ.
...
:ref:`spell--Tame` :sup:`У` :sup:`SOM` (очар.): Делает одомашненное животное более дружелюбным к вам.
