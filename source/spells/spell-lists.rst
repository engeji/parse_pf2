...
:ref:`spell--Mirrors-Misfortune` :sup:`SOM` (иллюз.): Разделяет на 2 копии. Уничтожении подделки проклинает атакующего.
...
:ref:`spell--Spiritual-Attunement` :sup:`Н, У` :sup:`SOM` (прегр.): Настраивает на планы мировоззрения, чтобы защитить вас и наносить урон существам противоположных этому плану.
