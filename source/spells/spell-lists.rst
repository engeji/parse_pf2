...
:ref:`spell--Fated-Confrontation` :sup:`SOM` (прориц.): Изолирует двух предопределенных противников и дает им изменить судьбы друг друга.
...
:ref:`spell--Element-Embodied` :sup:`SOM` (трансм.): Превращаетесь в громадного элементаля.

:ref:`spell--Fated-Confrontation` :sup:`SOM` (прориц.): Изолирует двух предопределенных противников и дает им изменить судьбы друг друга.

:ref:`spell--Nullify` :sup:`SOM` (прегр.): Реагируете, чтобы автоматически противодействовать заклинанию и получить урон от отдачи.

:ref:`spell--Summon-Kaiju` :sup:`Р` :sup:`SOM` (вопл.): Призываете инкарнацию кадзю с эффектами в зависимости от конкретного кайдзю.
