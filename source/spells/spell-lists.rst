...
:ref:`spell--Forceful-Hand` :sup:`У` :sup:`SOM` (эвок.): Создает руку из силы, которая может вмешиваться, чтобы защищать вас или атаковать, если усилена.
...
:ref:`spell--Portrait-Of-The-Artist` :sup:`SOM` (иллюз.): Будто у вас внешность и навыки известного артиста.
