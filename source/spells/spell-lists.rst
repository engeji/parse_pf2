...
:ref:`spell--Pocket-Library` :sup:`У` :sup:`SOM` (прориц.): Достает книгу из карманной библиотеки.

:ref:`spell--Quick-Sort` :sup:`У` :sup:`SOM` (трансм.): Автоматически сортирует множество объектов.

:ref:`spell--Restyle` :sup:`SOM` (трансм.): Делает постоянное изменение стиля одежды.
...
:ref:`spell--Biting-Words` :sup:`У` :sup:`SOM` (эвок.): Бросайт звуковые насмешки, чтобы ранить существ.
