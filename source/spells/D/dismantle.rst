...
Объект получает состояние :c_broken:`сломан` и части становятся достаточно маленькими, чтобы быть спрятанными под обычной одеждой или доспехом.
...
Как только пересобран, объект теряет свое состояние :c_broken:`сломан` и его ОЗ возвращаются к значению, которое было, когда вы применили :ref:`action--Cast-a-Spell`.
