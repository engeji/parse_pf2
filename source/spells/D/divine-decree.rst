...
| **Критический провал**: Существо получает двойной урон и "ослаблен 2" на 1 минуту. На вашем родном плане, существо, которое крит.провалило, изгоняется с эффектом провала :ref:`spell--b--Banishment`. Существо 10-го уровня или ниже должно совершить спасбросок Воли. При провале, оно парализовано на 1 минуту; при крит.провале оно умирает.
